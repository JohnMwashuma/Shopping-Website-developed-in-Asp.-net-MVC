        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    string cartid = userShoppingCart.GetCardId();
                    userShoppingCart.MigrateCart(cartid, model.Email);
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    string resetLink = "<a href='"
                       + Url.Action("ResetPassword", "Account", new { userId = user.Id, code = token }, "http")
                       + "'>Reset Password Link</a>";
                    //string resetLink = Url.Action(user.Id, "Please reset your password by clicking <a href=\"" + callbackUrl + "\">here</a>");
